...
enable: false
			...
			<td><p>Access Control configuration. <a href="https://docs.victoriametrics.com/vmgateway.html#access-control" target="_blank">https://docs.victoriametrics.com/vmgateway.html#access-control</a></p>
</td>
		</tr>
		<tr>
			<td>auth.enable</td>
...
""
			...
			<td><p>Use existing configmap if specified otherwise .config values will be used. Ref: <a href="https://victoriametrics.github.io/vmgateway.html" target="_blank">https://victoriametrics.github.io/vmgateway.html</a></p>
</td>
		</tr>
		<tr>
...
false
			...
			<td><p>should be true and means that you have the legal right to run a vmgateway that can either be a signed contract or an email with confirmation to run the service in a trial period <a href="https://victoriametrics.com/legal/esa/" target="_blank">https://victoriametrics.com/legal/esa/</a></p>
</td>
		</tr>
		<tr>
...
enable: false
			...
			<td><p>Rate limiter configuration. Docs <a href="https://docs.victoriametrics.com/vmgateway.html#rate-limiter" target="_blank">https://docs.victoriametrics.com/vmgateway.html#rate-limiter</a></p>
</td>
		</tr>
		<tr>
