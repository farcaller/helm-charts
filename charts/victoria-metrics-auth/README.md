...
""
			...
			<td><p>Use existing secret if specified otherwise .config values will be used. Ref: <a href="https://victoriametrics.github.io/vmauth.html" target="_blank">https://victoriametrics.github.io/vmauth.html</a>. Configuration in the given secret must be stored under <code>auth.yml</code> key.</p>
</td>
		</tr>
		<tr>
